...
save_folderpath = join(
    os.environ["ROOT_SAVE_FOLDER"],
    f"experiments/multi_news/translation/llama3.2-1B_translation/On_noisy_texts_with_{embedding_model}_embedding_model",
)
...
if corrected_texts:
    ...
    save_folderpath = join(
        os.environ["ROOT_SAVE_FOLDER"],
        f"experiments/multi_news/translation/llama3.2-1B_translation/On_noisy_texts_with_{embedding_model}_embedding_model_corrected",
    )
