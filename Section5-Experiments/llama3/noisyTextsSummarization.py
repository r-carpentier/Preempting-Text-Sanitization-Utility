...
save_folderpath = join(
    os.environ["ROOT_SAVE_FOLDER"],
    f"experiments/multi_news/summarization/llama_generated_summaries/On_noisy_texts_with_{embedding_model}_embedding_model",
)
...
if corrected_texts:
    ...
    save_folderpath = join(
        os.environ["ROOT_SAVE_FOLDER"],
        f"experiments/multi_news/summarization/llama_generated_summaries/On_noisy_texts_with_{embedding_model}_embedding_model_corrected",
    )
